...
do
   ...
   cp phenix/pdb_phenix-aniso*.pdb ../$name/${method[$m]}/$pdb_name
   cd Gz
   ...
   cp phenix/edstats/pdb_map_coeffs.mtz ../$name/${method[$m]}/$mtz_name
   cp phenix/edstats/pdb_2mFo-DFc_map.ccp4 ../$name/${method[$m]}/$FO_name
   cp phenix/edstats/pdb_mFo-DFc_map.ccp4 ../$name/${method[$m]}/$FC_name
   echo 3
   pwd
   cd ../$name
done
